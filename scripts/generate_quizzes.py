...
QUIZ_TITLES = {
    'quiz1_fondamentaux': 'Quiz 1 : Fondamentaux du logiciel',
    'quiz2_documentation': 'Quiz 2 : Documentation (CDC & fiche technique)',
    'quiz3_methodologies': 'Quiz 3 : Les méthodologies',
}
...
def main():
    # Configuration
    repo = os.environ.get('GITHUB_REPOSITORY', 'johnaoga/gl-sdlc')
